...
//                TestType.T, false, 2.2, 28, 0.030, true, isEqualities));
//        doReturn(tests).when(generator).generateStatTests(testQuantity);
//        doReturn(isEqualities).when(generator).generateEquality(testQuantity);
//
//        //when
//        String actual = builder.buildPrompt(testQuantity, domain, env);
//
...
//            Do not write anything else. If you can't, tell me why.""";
//        List<StatTest> tests = new ArrayList<>();
//        tests.add(new StatTest(TestType.T, true, 1.2, 27, 0.02, false, isEqualities));
//        tests.add(new StatTest(TestType.T, true, 2.2, 28, 0.03, true, isEqualities));
//        tests.add(new StatTest(TestType.T, false, 3.2, 29, 0.005, true, isEqualities));
//        tests.add(new StatTest(TestType.T, true, 4.2, 30, 0.07, false, isEqualities));
//        tests.add(new StatTest(TestType.T, false, 5.2, 31, 0.06, true, isEqualities));
//        doReturn(tests).when(generator).generateStatTests(testQuantity);
//        doReturn(isEqualities).when(generator).generateEquality(testQuantity);
//
//        //when
